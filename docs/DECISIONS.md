...
**Status:** Accepted (offline suite green + live probe PASSED 2026-08-15; final acceptance is user-run, as every milestone's)
...
**Status:** Accepted (written design-first after the live diagnosis; consequences updated after the offline suite + live re-verification)
