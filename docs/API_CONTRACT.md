...
(`/admin/metrics` was on this list and is IMPLEMENTED since M9, ADR-036; `/admin/accounts` is IMPLEMENTED read-only since M10, ADR-037 — see Implementation status.)
