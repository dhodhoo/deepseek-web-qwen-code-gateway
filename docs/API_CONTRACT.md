...
Last synchronized: M9 (ADR-036), on top of M8 + M7 (ADR-028). See also docs/PROGRESS.md and docs/DECISIONS.md (ADR-017..036).
...
(`/admin/metrics` was on this list and is IMPLEMENTED since M9, ADR-036 — see Implementation status.)
